...
```json
"features": {
    "ghcr.io/erjac77/devcontainers-features/docker-outside-of-docker:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/erjac77/devcontainers-features/blob/main/src/docker-outside-of-docker/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
